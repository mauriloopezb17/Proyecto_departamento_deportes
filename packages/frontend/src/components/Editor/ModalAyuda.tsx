...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      '⚠️ Para que el color se aplique: haz clic fuera del selector de color (en cualquier otra parte de la pantalla). El cambio se aplica al cerrar el picker, no al instante.',
